...
public final class Constants
{
    ...
    public static final class LauncherAngleConstants
    {
        ...
        public static final double kPos2Angle = 42.0; //TODO - find launcher angle for positio+n 2
    ...
    public static final class LauncherConstants
    {
        ...
        public static final double kSpeakerDefaultLeftSpeed = -0.26; //-0.4
        public static final double kSpeakerDefaultRightSpeed = -0.36; //-0.5
